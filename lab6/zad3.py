"""
Wykorzystując protokół telnet, oraz serwer ESMTP działający pod adresem interia.pl 
na porcie 587 wyślij wiadomość spoofed email (z podmienionym adresem nadawcy) używając 
komend protokołu ESMTP.
"""
...
DISPLAY_NAME = 'Fake Support'
FAKE_FROM = LOGIN  # musi być zgodny z serwerem

ODBIORCA = 'pasinf2026@interia.pl'
TEMAT = 'Zadanie 3 - Spoofed Email'
WIADOMOSC = 'To jest testowa wiadomość e-mail wysłana za pomocą protokołu ESMTP. Adres nadawcy został podmieniony (spoofing).'
...
def main():
    ...
    try:
        ...
        send_command(tls_sock, f'MAIL FROM:<{FAKE_FROM}>', expected_code=250)
